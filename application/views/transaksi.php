      ...
      <tbody>
         ...
         ?>
            ...
            <tr>
               ...
               <td class="center">
                  <a href="<?=site_url('home/detail_transaksi/'.$key->id_order)?>" class="btn btn-floating" style="background-color: #007a7a;"><i class="fa fa-search-plus"></i></a>
...
<br />
<div class="right">
   <button type="button" class="btn rounded" onclick="window.history.go(-1)" style="background-color: #003f5a;width: 120px;">Kembali</button>
</div>
<br/>
