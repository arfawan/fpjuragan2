...
<html lang="en">
   ...
   <body class="nav-md" style="background-color: #303030">
      <div class="container body"  style="background-color: #303030"  >
         <div class="main_container" style="background-color: #303030">
            <?php echo $nav; ?>
