               ...
               <div class="row">
                  <div class="col m10 s12 offset-m1">
                     ...
                     <div class="modal-footer">
                        <button type="submit" name="submit" value="Submit" class="modal-action btn rounded" style="background-color: #003f5a;width: 180px;">Simpan</button>
                     </div>
                  </div>
               </div>
            </form>
...
<br />
<div class="right">
   <a href="<?= site_url('checkout'); ?>" class="btn rounded" style="background-color: #003f5a;width: 180px;"><i class="fa fa-shopping-bag" ></i> Checkout</a>
   <button type="button" class="btn rounded" onclick="window.history.go(-1)" style="background-color: #007a7a;width: 120px;">Kembali</button>
</div>
<br/>
