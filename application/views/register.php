...
<div class="row">
   <div class="col m10 s12 offset-m1">
      <h4 style="color: #007a7a;"><i class="fa fa-pencil-square-o" style="color: #007a7a;"> Form Registrasi</i> </h4>
      <hr />
      <br />
      ...
      <form action="" method="post">
         <div class="col m10 s12">
            ...
            <div class="row right">
               <button type="submit" name="submit" value="Submit" class="btn waves-effect waves-light" style="background-color: #003f5a">Submit <i class="fa fa-paper-plane"></i></button>
               <button type="button" onclick="window.history.go(-1)" class="btn waves-effect waves-light" style="background-color: #007a7a;">Kembali</button>
            </div>
         </div>
      </form>
   </div>
